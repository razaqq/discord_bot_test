    ...
    async def load(self, ctx, module):
        ...
        if author_id in self.admins:
            try:
                ...
                logging.log(20, 'Ext {} was successfully loaded by {}'.format(module, ctx.message.author.name))
        else:
    ...
    async def unload(self, ctx, module):
        ...
        if author_id in self.admins:
            try:
                ...
                await self.bot.say('\N{OK HAND SIGN}')
                logging.log(20, 'Ext {} was successfully unloaded by {}'.format(module, ctx.message.author.name))
        else:
            await self.bot.say("You don't have permissions")
    ...
    async def _reload(self, ctx, module):
        ...
        if author_id in self.admins:
            try:
                ...
                await self.bot.say('\N{OK HAND SIGN}')
                logging.log(20, 'Ext {} was successfully reloaded by {}'.format(module, ctx.message.author.name))
        else:
            await self.bot.say("You don't have permissions")
    ...
    async def enable(self, ctx, module):
        ...
        if author_id in self.admins:
            try:
                ...
                await self.bot.say('\N{OK HAND SIGN}')
                logging.log(20, 'Ext {} was successfully enabled by {}'.format(module, ctx.message.author.name))
        else:
            await self.bot.say("You don't have permissions")
    ...
    async def disable(self, ctx, module):
        ...
        if author_id in self.admins:
            try:
                ...
                await self.bot.say('\N{OK HAND SIGN}')
                logging.log(20, 'Ext {} was successfully disabled by {}'.format(module, ctx.message.author.name))
        else:
            await self.bot.say("You don't have permissions")
